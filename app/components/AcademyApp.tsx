    ...
    <div className="academy-shell">
      ...
      <main className="academy-main">
        ...
        <footer className="academy-footer">
          <p>OneDash Academy là môi trường đào tạo mô phỏng. Nội dung tính năng được biên soạn từ <a href={courseSource.href} target="_blank" rel="noreferrer">onedash.vn</a>, rà soát ngày {courseSource.reviewedAt}. Không có kết nối server thật.</p>
        </footer>
      </main>
